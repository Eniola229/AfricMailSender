...
<head>
    ...
    <!-- site metas -->
    <title>AfricICL | Dashboard</title>
                                    ...
                                    <div class="dash_blog_inner">
                                        <div class="dash_head">
                                            <h3><span>
                                                    ...
                                                    |Send Mail</span><span class="plus_green_bt"></span></h3>
                                        </div>
                                        <div class="list_cont">
                                            <p>Send Mails</p>
                                        </div>
                                        <div class="task_list_main">
                                        <form action="{{ route('sendmails.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                        <div class="container">
                                            <div class="col-md-5">
                                            <label for="inputEmail4" class="form-label">Subject</label>
                                            <input type="text" placeholder="Subject" name="subject" class="form-control" id="inputEmail4">
                                            <x-input-error :messages="$errors->get('subject')" class="mt-2" />
                                          </div>
                                          <div class="col-md-5 mt-2">
                                            <label for="" class="form-label">Title</label>
                                            <input type="text" placeholder="Title" name="title" class="form-control" id="">
                                          </div>
                                          <div class="input-group col-md-5 mt-3">
                                              <span class="input-group-text">Message Heading</span>
                                              <textarea class="form-control" name="message_head" aria-label="With textarea"></textarea>
                                              <x-input-error :messages="$errors->get('message_head')" class="mt-2" />
                                          </div>
                                          <div class="input-group mt-3 col-md-5">
                                              ...
                                              <x-input-error :messages="$errors->get('message_body')" class="mt-2" />
                                          </div>
                                          <div class="input-group mt-3 col-md-5">
                                              <span class="input-group-text">Message Ending</span>
                                              <textarea class="form-control" name="message_ending" aria-label="With textarea"></textarea>
                                              <x-input-error :messages="$errors->get('message_ending')" class="mt-2" />
                                          </div>
                                          <div class="col-md-4 mt-3">
                                            <label for="inputAddress2" class="form-label">Attach Image</label>
                                            <input type="file" name="attachments" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
                                    ...
                                    <div class="dash_blog_inner">
                                        <div class="dash_head">
                                            <h3><span>
                                                   ...
                                                   Add Users</span><span class="plus_green_bt"><a
                                                        href="#"></a></span></h3>
                                        </div>
                                        <div class="list_cont">
                                            <p>Add Users (Customers)</p>
                                        </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <input type="text" placeholder="Name" name="name" class="form-control" id="inputEmail4">
                                         ...
                                         <div class="col-md-5 mt-2">
                                            ...
                                            <input type="text" placeholder="Plan" name="plan" value="Plan(1)" class="form-control" id="">
